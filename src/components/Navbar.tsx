...
export default function Navbar() {
  ...
  <button onClick={() => scrollToSection('modules')} className="text-gray-300 hover:text-blue-400 font-medium transition-colors">学习模块</button>
  ...
  <button onClick={() => scrollToSection('modules')} className="text-gray-300 hover:text-blue-400 font-medium transition-colors py-2 px-4">学习模块</button>
